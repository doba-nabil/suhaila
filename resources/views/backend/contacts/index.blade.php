...
@section('backend-main')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Messages From Contact Page</h4>
                    <div style="display: flex;justify-content: space-between;">
                        <a class="btn btn-danger mb-2  delete-all text-white" onclick="return false;"
                           delete_url="/delete_contacts/"><i class="mdi mdi-trash-can-outline mr-2"></i>Delete All</a>
                    </div>
                    <hr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a title="" onclick="return false;" object_id="{{ $contact->id }}"
                                       delete_url="/contacts/" class="text-danger remove-alert" href="#">
